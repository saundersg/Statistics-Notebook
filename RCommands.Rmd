...
The best way to learn R is to open RStudio and try all the **Example** codes yourself that are listed on this page.

Click on a code to see what it does. Hover to learn more.
...
Here is a command you can run to see the "built in" data sets in R.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;gender = case_when(sex == "B" ~ "Boy", sex == "G" ~ "Girl"),
  <span class="tooltipRtext">"gender" is a name we came up with that will store the results of the transformation of the "sex" column. The case_when(...) function is being used to change the values of "B" to "Boy" and the values of "G" to "Girl".</span>
</span><br/><span class="tooltipr">
...
```{}
case_when(birthmonth == 1 ~ "January",
...
```{}
case_when(birthmonth %in% c(12,1,2) ~ "Winter",
