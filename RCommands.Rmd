...
<a href="javascript:showhide('hovertobegin')">Hover your mouse here to begin.</a>
  <span class="tooltipRtext">Good work! <br/> Now "click" to get started. </span>
</span>
...
Hover over <span class="tooltipr">`code`<span class="tooltipRtext">Yes, just like that. By hovering over "Codes" you will get instructions on what that code does.</span></span> to read about it. Click on a line of code to see what it does. Try typing the code into RStudio yourself to actually start learning R.
...
<span class="tooltipr">
View(
  <span class="tooltipRtext">The "View" R function (with a CAPTIAL 'V' in View) allows us to view a datset. When run, this function will open up a new tab in RStudio showing the dataset.  </span>
</span><span class="tooltipr">
cars
  <span class="tooltipRtext">`cars` is a data set that is in R. R has datasets that are available for anyone to use. You can see them using the `data()` command. It would be good to explore `View()` a few different datasets. </span>
</span><span class="tooltipr">
)
...
R allows you to work with data. So, the first step to understanding R is to open a dataset and begin exploring some data. The `View` command will help you get started with this.
...
Once you select a dataset like `cars` or `airquality` that you want to learn more about, this is how you look at it.
...
Hover to read. Click to view. Try to learn.

<a href="javascript:showhide('CarsOutput')">
<div class="hoverchunk">
<span class="tooltipr">
View(
  <span class="tooltipRtext">An R function "View" allows us to view the datset that we select. This will open up a new tab in RStudio showing the dataset. Be sure to include the opening parentheses. </span>
</span><span class="tooltipr">
cars
  <span class="tooltipRtext">`cars` is a data set that is in R. R has datasets that are available for anyone to use. You can see them using the `data()` command. It would be good to explore `View()` a few different datasets. </span>
</span><span class="tooltipr">
...
In addition to the `View` command, there are other nifty commands that allow you a quick glance at your data.

<span style="color:steelblue;font-size:.8em;padding-left:160px;">Additional Commands</span> <a href="javascript:showhide('head_tail_glimpse')" style="font-size:.6em;color:skyblue;">(Click here to see more commands.)</a>

<div id="head_tail_glimpse" style="display:none;font-size:.9em;">

#### head() & tail()

The `head` command shows the first few rows of a dataset, while the `tail` command shows the last few rows.
...
<a href="javascript:showhide('head')">
<div class="hoverchunk">
<span class="tooltipr">
head(
  <span class="tooltipRtext">The `head` command allows us to see the first few rows of a datset that we select. The output will appear in the console. This command can be useful when working in an R script or R Markdown file, or when you simply need a quick glance at the data.</span>
</span><span class="tooltipr">
cars
  <span class="tooltipRtext">`cars` is a data set that is in R.</span>
</span><span class="tooltipr">
)
  <span class="tooltipRtext">Always be sure to end your function with closing parentheses. </span>
</span><span class="tooltipr">
&nbsp;&nbsp;&nbsp;&nbsp;  
  <span class="tooltipRtext">Press Enter to run the code.</span>
</span><span class="tooltipr" style="float:right;font-size:.8em;">
...
<div id="head" style="display:none;padding-left:20px;">

Insert Image Here

</div>

<a href="javascript:showhide('tail')">
<div class="hoverchunk">
<span class="tooltipr">
tail(
  <span class="tooltipRtext">The `tail` command allows us to see the last few rows of a datset that we select. The output will appear in the console. This can be useful when working in an R script or R Markdown file, or when you simply need a quick glance at the data.</span>
</span><span class="tooltipr">
airquality)
  <span class="tooltipRtext"> Gives us data concerning air quality measurements around New York City, NY. For more details on this dataset type: `?airquality`</span>
</span><span class="tooltipr">
...
<div id="tail" style="display:none;padding-left:20px;">
...
The `glimpse` command gives you a glimpse of a dataset. To use the `glimpse` command, first ensure either `library(dplyr)` or `library(tidyverse)` is loaded. 
...
<a href="javascript:showhide('glimpseOutput')">
<div class="hoverchunk">
<span class="tooltipr">
glimpse(
  <span class="tooltipRtext">The `glimpse` command allows us to see the number of observations (rows) and variables (columns) in a dataset. It shows the column names and a few of the values in those columns. The output will appear in the console. This can be useful when working in an R script or R Markdown file, or when you simply need a quick *glimpse* of the data.</span>
</span><span class="tooltipr">
cars
  <span class="tooltipRtext">`cars` is a data set that is in R.</span>
</span><span class="tooltipr">
...
<div id="glimpseOutput" style="display:none;padding-left:20px;">
...
R has many "built-in" datasets to choose from, which you can see by running the `data` commmand.
</div>

<span style="color:steelblue;font-size:.8em;padding-left:160px;">data()</span> <a href="javascript:showhide('data')" style="font-size:.6em;color:skyblue;">(Click here to learn about the data() command.)</a>

<div id="data" style="display:none;font-size:.9em;">

Here is a command you can run to see the "built in" datasets in R. Type `data()` in the console, leaving the parentheses empty, and press *Enter* to run the code.
...
()
  <span class="tooltipRtext">Functions always have parentheses following the function name. For this function we do not put anything inside the parentheses.</span>
</span><span class="tooltipr">
&nbsp;&nbsp;&nbsp;&nbsp;  
  <span class="tooltipRtext">Press Enter to run the code.</span>
</span><span class="tooltipr" style="float:right;font-size:.8em;">
&nbsp;Double-Click to Hide Output&nbsp; 
  <span class="tooltiprtext">Click to see output.</span>
</span>
</div>
</a>
<div id="DataOutput" style="display:show;padding-left:20px;">
