...
For each of the following examples, hover, click, and try.
...
Here is what the output of the command `View(airquality)` looks like.
...
Notice that the list of available data sets in R includes the "airquality" and "cars" data sets that we "Viewed" previously. 

There are many, many other data sets you can View and use as well. You can also bring your own data sets into R, as you will learn later this week.
...
Once you finish working through the three above example codes, move on to studying the codes below.
