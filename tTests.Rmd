...
sleep1 <- filter(sleep, group==1)
sleep2 <- filter(sleep, group==2)
t.test(sleep2$extra, sleep1$extra, paired=TRUE, mu = 0, alternative = "two.sided", conf.level = 0.95)
```
...
```{r, echo=FALSE}
t.test(KidsFeet$length[KidsFeet$sex=="B"], KidsFeet$length[KidsFeet$sex=="G"], mu=0, alternative="two.sided", conf.level=0.95)
```
