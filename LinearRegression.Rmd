...
$\overbrace{\beta_0}^\stackrel{\text{true}}{\text{y-intercept}} + \overbrace{\beta_1}^\stackrel{\text{true}}{\text{slope}} X_i$
...
$\ \epsilon_i \sim N(0, \sigma^2)$
  <span class="tooltiprtext">The error terms $\epsilon_i$ are assumed to be independent and identically distributed normal random variables with constant variance. Pay special note that the $\sigma$ does not have an $i$ in it, so it is the same for each individual. In other words, the variance is constant. The mean of the errors is zero, which causes the dots to be spread out symmetrically both above and below the line.</span>
</span>
</center>
...
$\overbrace{\ b_0 \ }^\stackrel{\text{est.}}{\text{y-intercept}} + \overbrace{b_1}^\stackrel{\text{est.}}{\text{slope}} X_i$
