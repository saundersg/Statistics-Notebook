...
The output above shows the lower and upper bounds of 90% confidence intervals for the parameters $\beta_0$ and $\beta_1$. The 90% confidence interval starts at the 5th percentile and ends at the 95th, hence the 5% and 95% as the column names. In this example, the confidence interval for the y-intercept does not make sense because you cannot have negative distance. However, you can be 90% confident that the slope lies between 3.235501 and 4.629317.
