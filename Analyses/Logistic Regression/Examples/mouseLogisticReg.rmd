...
Analysis <- read_csv("../../../Data/mouse.csv")
...
```{r}
plot(Death~CoefficientK, data = Analysis2,  pch=16, main = "Bohomolets Institute of Physiology of Ukraine\n Anesthesia for Adult Mice", xlab = "Ketamine Dosage Coefficient for a Body of Weight of a Mouse", ylab = "Probability of Mouse's Death", col ="firebrick")
