...
To *italicize* a word use the asterisk (Shift 8) `*italisize*`. To **bold** a word use the double asterisk `**bold**`. The back tic ` ` ` can be used to `highlight` words by placing back tics on each side of a word: ` ` ` highlight ` ` `.
