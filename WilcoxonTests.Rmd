...
mu = 0,&nbsp; 
  <span class="tooltiprtext">For the median of differences from the paired data the numeric value from the null hypothesis is 0 meaning the null hypothesis is $\text{median of differences} = 0$.</span>
</span><span class="tooltipr">
...
wilcox.test(sleep$extra[sleep$group==1], sleep$extra[sleep$group==2], mu = 0, alternative = "two.sided", paired = TRUE, conf.level = 0.95)
```
